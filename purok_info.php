				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold"><?= $state=='purok' ? 'Zone' : 'Precint' ?></h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><?= $state=='purok' ? 'Zone Information' : 'Precint Information' ?></div>
									</div>
								</div>
								<div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-stats ">
                                                <div class="numbers">
                                                    <p class="card-category text-light"><?= $state=='purok' ? 'Total Zone' : 'Total Precint' ?></p>
