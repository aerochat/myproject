							...
							<div class="card card-stats card-round" style="background-color:#a349a3; color:#fff">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												<h2 class="fw-bold text-uppercase">Precint Number</h2>
							...
							<div class="card card-stats card-round" style="background-color:#880a14; color:#fff">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												<h2 class="fw-bold text-uppercase">Zone Number</h2>
								...
								<div class="card-body">
									<a href="purok_info.php?state=purok" class="card-link text-light">Zone Information</a>
								</div>
							</div>
						</div>
						<div class="col-md-4">
